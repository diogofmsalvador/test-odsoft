...
public class ExampleGWTTest extends GWTTestCase {
	...
	private pt.isep.cms.contacts.client.ContactsServiceAsync rpcService;
	...
	public void gwtSetUp() {
		rpcService = GWT.create(pt.isep.cms.contacts.client.ContactsService.class);
	...
	public void testContactsService() {
		...
		pt.isep.cms.contacts.client.ContactsServiceAsync contactsService = GWT.create(pt.isep.cms.contacts.client.ContactsService.class);
